 ...
 * @author
 */
class RAINBOWPAY extends BASES {
    public $http_code;

    static function instantiation() {
        return new RAINBOWPAY();
    }
    ...
    public function initParam() {
        ...
        $data = array(
            ...
            'notifyUrl'         => $this->payCallbackDomain . '/pay/callback/rainbowpay',
            /*'callBackUrl'       => '',
            'otherData'         => '',
            'remark'            => '',
            'number'            => '',
    ...
    {
        $config    = Recharge::getThirdConfig('rainbowpay');
        $this->key = $config['key'];
