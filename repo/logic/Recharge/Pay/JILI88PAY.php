 ...
 * jili88pay
 */
class JILI88PAY extends BASES {
    public $http_code;

    static function instantiation() {
        return new JILI88PAY();
    }
    ...
    public function initParam() {
        ...
        $data = array(
            ...
            'bank_code'        => $this->rechargeType,
            'callback_url'     => $this->payCallbackDomain . '/pay/callback/jili88pay',
            'return_url'       => $this->returnUrl ?? 'no returnUrl',
        );
...
//        echo '<pre>';print_r($this->parameter);exit;
    ...
    {
        $config    = Recharge::getThirdConfig('jili88pay');
        $this->key = $config['key'];
