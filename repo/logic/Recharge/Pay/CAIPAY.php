...
class CAIPAY extends BASES {
    ...
    public function initParam() {
        ...
        $data = array(
            ...
            'bank_code'        => $bank_code,
            'callback_url'     => $this->payCallbackDomain . '/pay/callback/caipay',
            'return_url'       => $this->returnUrl??'no return_url',
        );
...
//        echo '<pre>';print_r($this->parameter);exit;
    ...
    {
        $config    = Recharge::getThirdConfig('caipay');
        $this->key = $config['key'];
