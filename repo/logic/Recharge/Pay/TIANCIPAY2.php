 ...
 * @author
 */
class TIANCIPAY2 extends BASES {
    public $http_code;

    static function instantiation() {
        return new TIANCIPAY2();
    }
    ...
    public function initParam() {
        ...
        $data = array(
            ...
            'callback_url' => $this->payCallbackDomain . '/pay/callback/tiancipay2',
        );
...
//        echo '<pre>';print_r($this->parameter);exit;
    ...
    {
        $config    = Recharge::getThirdConfig('tiancipay2');
        $this->key = $config['key'];
