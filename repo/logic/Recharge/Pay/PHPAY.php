...
class PHPAY extends BASES {
    ...
    public function initParam() {
        ...
        $data = array(
            ...
            'callback_url'     => $this->payCallbackDomain . '/pay/callback/phpay',
            'return_url'       => $this->returnUrl??'no_return',
        );
...
//        echo '<pre>';print_r($this->parameter);exit;
    ...
    {
        $config    = Recharge::getThirdConfig('phpay');
        $this->key = $config['key'];
