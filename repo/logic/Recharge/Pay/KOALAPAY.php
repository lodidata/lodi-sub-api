...
class KOALAPAY extends BASES
{
    ...
    public function initParam()
    {
        ...
        $data = array(
            ...
            'ord_id'     => $this->orderID,
            'p_method'   => $rechargeType,
            'notify_url' => $this->payCallbackDomain . '/pay/callback/koalapay'
        );
...
//        echo '<pre>';print_r($this->parameter);exit;
    ...
    public function parseRE()
    {
        ...
        $status = isset($result['err']) ? $result['err'] : '';
    ...
    {
        $config = Recharge::getThirdConfig('koalapay');
        $this->key = $config['key'];
