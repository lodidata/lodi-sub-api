...
class U2GCASHPAY extends BASES {
    public $http_code;

    static function instantiation() {
        return new U2GCASHPAY();
    }
    ...
    public function initParam() {
        ...
        $data = array(
            ...
            'bank_code'        => 'gcash',
            'callback_url'     => $this->payCallbackDomain . '/pay/callback/u2gcashpay',
...
//        echo '<pre>';print_r($this->parameter);exit;
    ...
    {
        $config    = Recharge::getThirdConfig('u2gcashpay');
        $this->key = $config['key'];
