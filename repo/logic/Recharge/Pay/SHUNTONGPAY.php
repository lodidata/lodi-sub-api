 ...
 * shutongpay
 */
class SHUNTONGPAY extends BASES {
    public $http_code;

    static function instantiation() {
        return new SHUNTONGPAY();
    }
    ...
    public function initParam() {
        ...
        $data = array(
            ...
            'bank_code'        => 'gcash',
            'callback_url'     => $this->payCallbackDomain . '/pay/callback/shuntongpay',
...
//        echo '<pre>';print_r($this->parameter);exit;
    ...
    {
        $config    = Recharge::getThirdConfig('shuntongpay');
        $this->key = $config['key'];
