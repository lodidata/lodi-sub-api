...
class IG
{
    ...
    public function records($condition, $page = 1, $pageSize = 20)
    {
        ...
        foreach ($data ?? [] as $k => $v) {
            ...
            // 玩法名
            $result[$k]['play_name'] = $app->getContainer()->lang->text($this->game_type);
            // 输赢
    ...
    public function detail($condition)
    {
        ...
        $result = [
            ...
            // 中奖金额
            'send_money' => $data->winLoss,
        ];
        $result += $this->parseRecordsState($data->winLoss, $data->gameDate);
        ...
        $detail = [
            ...
            [
                ...
                'value' => bcdiv($data->winAmount, 100, 2)
            ],
            [
