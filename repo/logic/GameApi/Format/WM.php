    ...
    private function getRecord($condition) {
        ...
        if(isset($condition['statistics'])) {
            ...
            $select = [
                ...
                'user_id'       => 'user_id',
                // 返还金额
                'winLoss'       => 'prize_amount as winLoss',
                // 下注金额
                'betAmount'     => 'bet',
                //有效下注金额
                'validBet'      => 'validbet',
                //盈利
                'profit'        => 'winLoss as income',
                // 下注时间
                ...
                'roundId'       => 'event',
                //游戏代码
                'gameCode'      => 'gid as kind_id',
                'gameName'      => 'gname as gameName'
            ];

            // 详情
            if(isset($condition['info'])) {
                //注单详情
                $select['betDetail'] = 'betResult';
                // 游戏结果
                $select['result'] = 'gameResult';
            }
