...
class YYPAY extends BASES {
    ...
    public function runTransfer() {
        ...
        $data            = [
            ...
            'mobile'        => $this->mobile,
            'ifscCode'      => $this->getBankName(),
            'notifyAddress' => $this->payCallbackDomain . '/thirdAdvance/callback/yypay',
        ];
        ...
        if($this->httpCode == 200) {
            if($result['success']) {
                ...
                $this->return['msg']     = 'YYPAY:' . $message ?? '代付失败';
                return;
            }
        }
    ...
    public function callbackResult($params) {
        ...
        $this->re = $this->return;
        $this->updateTransferOrder($this->money, $real_money, $params['merchantBizNum'],//第三方转账编号
            '', $status);
    }
