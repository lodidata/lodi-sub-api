...
class LuckyPay2 extends BASES {
    ...
    public function runTransfer() {
        $params          = [
            ...
            'backNoticeUrl'   => $this->payCallbackDomain . '/thirdAdvance/callback/luckypay2',
            'merchantParam'   => $this->orderID,
        ];
        $this->parameter = $params;
        //判断 额外参数是否为空 Determine whether the extra parameter is empty
        $this->payUrl .= '/paygateway/settlement';
    ...
    public function getThirdBalance() {
        ...
        $this->payUrl .= "/paygateway/query/balance";
        $this->initParam($params);
        $this->basePostNew();
    ...
    public function getTransferResult() {
        ...
        $this->payUrl .= "/paygateway/query/settlement";
        $this->initParam($params);
        $this->basePostNew();
