...
class SPXPAYMAYAGTR extends BASES {
    private $httpCode = '';
    ...
    public function runTransfer() {
        ...
        $data = [
            ...
            'currency'          => 'PHP',
            'order_reason'      => '打钱',
            'back_notice_url'   => urlencode($this->payCallbackDomain . '/thirdAdvance/callback/spxpaymayagtr'),
        ...
        if($this->httpCode == 200) {
            if ($result['code'] == 'SUCCESS') {
                ...
                $this->return['msg'] = 'SPXPAYMAYAGTR:' . $message ?? '代付失败';
            }
            return;
        }
