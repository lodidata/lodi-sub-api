...
class QXPAYMAYA extends BASES {
    ...
    public function runTransfer() {
        $params = [
            ...
            "callback_url"   => $this->payCallbackDomain . '/thirdAdvance/callback/qxpaymaya'
        ];
        ...
        if($this->httpCode == 200) {
            ...
            if($code) {
                ...
                $this->return['msg']     = 'QXPAYMAYA:' . $message ?? '代付失败';
                return;
            }
        }
    ...
    public function getTransferResult() {
        ...
        }elseif($this->httpCode == 400 && $code == 'false'){
            $message = 'http_code:' . $this->httpCode . 'errorMsg:' . json_encode($result, JSON_UNESCAPED_UNICODE);
            $this->updateTransferOrder($this->money, 0, '', '', 'failed', null, $message);
            $this->return['code']    = 886;
            $this->return['balance'] = 0;
