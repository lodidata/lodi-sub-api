 ...
 * TIGERPAYMAYA代付
 */
class TIGERPAYMAYA extends BASES {
    private $httpCode = '';
    ...
    public function runTransfer() {
        $params = [
            ...
            "callback_url"   => $this->payCallbackDomain . '/thirdAdvance/callback/tigerpaymaya'
        ];
        ...
        if($this->httpCode == 200) {
            ...
            if($code) {
                ...
                $this->return['msg']     = 'TIGERPAYMAYA:' . $message ?? '代付失败';
                return;
            }
        }
    ...
    private function getBankName()
    {
        ...
        if($country_code == 'ncg'){
            ...
            $banks = [
                'ALLBANK (A Thrift Bank), Inc.' => 'ALB',
                'RBG' => 'RBG',
                'AUB' => 'AUB',
                'Bangko Mabuhay (A Rural Bank), Inc.' => 'BMB',
                'BOC' => 'BOC',
                'BDO Network Bank, Inc.' => 'ONB',
                ...
                'Metropolitan Bank and Trust Co' => 'MET',
                'Paymaya Philippines, Inc.' => 'PAYMAYA',
                'PBB' => 'PBB',
                'PBC' => 'PBC',
                'PNB' => 'PNB',
                'PSB' => 'PSB',
                'Rizal Commercial Banking Corporation' => 'RCI',
                'SBC' => 'SEC',
                'Starpay' => 'SPY',
