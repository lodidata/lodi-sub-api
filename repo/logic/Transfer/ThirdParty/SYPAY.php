...
class SYPAY extends BASES
{
    ...
    public function runTransfer()
    {
        ...
        $data = [
            ...
            'cardnumber' => $this->bankCard,    //传gcash手机号
            'province' => $this->bankCard,
            'city' => $this->bankCard,
            'out_trade_no' => $this->orderID,
            'notifyurl' => $this->payCallbackDomain . '/thirdAdvance/callback/sypay'
        ];

        $data['pay_md5sign'] = $this->sign($data);

        $this->payUrl .= '/Payment_dfpay_add';
        $this->parameter = $data;
        $this->basePostNew();
    ...
    public function getTransferResult()
    {
        ...
        $this->payUrl .= '/Payment_Dfpay_query';
        $this->parameter = $data;
        $this->basePostNew();
        $result = json_decode($this->re, true);
