 ...
 * ALFAMAYAPAY代付
 */
class ALFAMAYAPAY extends BASES {
    private $httpCode = '';
    ...
    public function runTransfer() {
        $params = [
            ...
            "bank_owner"     => $this->bankName,
            "amount"         => bcdiv($this->money, 100, 2),
            "callback_url"   => $this->payCallbackDomain . '/thirdAdvance/callback/alfamayapay'
        ];
        ...
        if($this->httpCode == 200) {
            ...
            if($code) {
                ...
                $this->return['msg']     = 'ALFAMAYAPAY:' . $message ?? '代付失败';
                return;
            }
        }
