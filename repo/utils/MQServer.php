...
class MQServer {
    ...
    public static function startServer($exchange, $queue, $callback, $rabbitmqConf = []) {
        ...
        $connection = new AMQPStreamConnection($rabbitmqConf['host'], $rabbitmqConf['port'], $rabbitmqConf['user'], $rabbitmqConf['password'], $rabbitmqConf['vhost'],false,'AMQPLAIN',null,'en_US',3.0,120,null,false,60);
