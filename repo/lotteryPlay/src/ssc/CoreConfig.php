...
/*
    ...
    72 => [
        'name'             => ['标准', '前三', '三中一'],
        'result'           => ['exec' => 'SSCResult::resultBHsym', 'args' => ['start' => 2, 'len' => 3]],
        'format'           => ['exec' => 'SSCFormat::format', 'args' => ['playNumberLenth' => 1]],
        'valid'            => ['exec' => 'SSCValid::valid', 'args' => ['defaultBetCount' => 1]],
        'standardOdds'     => [3.69],
        'standardOddsDesc' => ['三中一'],
        'pretty'           => ['exec' => 'SSCPretty::pretty5Zxfs'],
    ],
/*
    73 => [
    ...
    85 => [
        'name'             => ['标准', '前三', '前三组选'],
        'result'           => ['exec' => 'SSCResult::resulth3zxsxbgz', 'args' => ['start' => 2, 'len' => 3]],
        'format'           => ['exec' => 'SSCFormat::format', 'args' => ['playNumberLenth' => 3]],
        'valid'            => ['exec' => 'SSCValid::valid', 'args' => ['defaultBetCount' => 1]],
        'standardOdds'     => [1000],
        'standardOddsDesc' => ['前三组选'],
        'pretty'           => ['exec' => 'SSCPretty::pretty5Zx'],
    ],

    86 => [
        'name'             => ['标准', '后二', '二中一'],
        'result'           => ['exec' => 'SSCResult::resultBH2ym', 'args' => ['start' => 0, 'len' => 2]],
        'format'           => ['exec' => 'SSCFormat::format', 'args' => ['playNumberLenth' => 1]],
        'valid'            => ['exec' => 'SSCValid::valid', 'args' => ['defaultBetCount' => 1]],
        'standardOdds'     => [3.69],
        'standardOddsDesc' => ['二中一'],
        'pretty'           => ['exec' => 'SSCPretty::pretty5Zxfs'],
    ]
];
