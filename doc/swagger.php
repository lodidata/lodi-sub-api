...
class SGR {
    ...
    protected $common = '[后端文档地址](http://192.168.10.57:9999/admin.html)'.PHP_EOL.
                        '[前端文档地址](http://192.168.10.57:9999/)  '.PHP_EOL.
                        '[重构说明](http://192.168.10.57:9999/rebuild.html)  '.PHP_EOL;
    ...
    public function initWWWApi() {
        $base = [
            ...
            'servers' => [
                0 => [
                    'url' => 'http://api-www.bag.cc/',
                    'description' => '内网开发环境，请指定host',
                ],
                1 => [
                    'url' => 'http://api-www.cbbcbybb.com/',
                    'description' => '外网测试环境',
                ],
            ],
            'paths' => [
    ...
    public function initAdminApi() {
        $base = [
            ...
            'servers' => [
                0 => [
                    'url' => 'http://api-admin.bag.cc',
                    'description' => '内网开发环境，请指定host',
                ],
                1 => [
                    'url' => 'http://api-admin.cbbcbybb.com',
                    'description' => '外网测试环境',
                ],
            ],
            'paths' => [
...
$content = yaml_emit($data, YAML_UTF8_ENCODING, YAML_ANY_BREAK);
$content = substr($content, 3, strlen($content) - 7);
file_put_contents(__DIR__.'/admin-api.swagger.yaml', $content);
