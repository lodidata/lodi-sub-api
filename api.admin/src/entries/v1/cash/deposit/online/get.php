...
return new class() extends BaseController
{
    ...
    const SCHEMAS     = [
        [
            ...
            'pay_no'              => 'string #交易号',
            'ip'                  => 'string   #ip',
            'recharge_time'       => 'datetime()    #交易时间',
            'coupon_money'        => 'int    #优惠金额',
            'withdraw_bet'        => 'int    #取款要求',
            'coupon_name'         => 'int #优惠名称',
            'memo'                => 'string #备注',
            'status'              => 'enum[paid, pending, failed]    #状态 [paid, pending, failed]',
            'state'               => 'enum[show, new, auto, online] #集合[show, new, auto, online]',
        ],
    ];
    ...
    public function run($id)
    {
        ...
        $data->is_new = in_array('new', $state) ? 1:0;
        return (array)$data;
    }
};
