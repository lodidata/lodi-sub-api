  ...
  SELECT *
    FROM (SELECT t.count_date,
            ...
            LEFT JOIN (SELECT "', v_begin_date, '" count_date,
                              ...
                              SUM(CASE WHEN fdl1.deal_type in (213) THEN fdl1.deal_money ELSE 0 END) / 100 confiscate_amount,
                              SUM(CASE WHEN fdl1.deal_type in (213) THEN 1 ELSE 0 END) confiscate_cnt,
                       ...
                       WHERE fdl1.deal_type IN (101, 102, 105, 106, 107, 109, 113, 114, 201, 204, 213, 308, 309, 501)
					     AND u.tags != 4
