	...
	FROM `user` u
		LEFT JOIN (
			SELECT user_id
				...
				, IFNULL(SUM(CASE
					WHEN deal_type IN (702,703,105, 114) THEN deal_money
					ELSE 0
			...
			FROM funds_deal_log
			WHERE deal_type IN (101, 102, 105, 106, 107, 109, 113, 114, 201, 204, 308, 309,701,702,703)
