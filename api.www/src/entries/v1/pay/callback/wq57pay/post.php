...
return new class extends Action
{
    ...
    public function run() {
        ...
        $signature=$this->request->getHeader('signature')[0];
        ...
        \Logic\Recharge\Recharge::addLogByTxt(['third' => $pay_type, 'date' => date('Y-m-d H:i:s'), 'header' => $header, 'response' => ''], 'pay_callback');
