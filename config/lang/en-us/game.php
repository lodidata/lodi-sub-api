...
$res = [
    ...
    "Dear customer '%s', (team back service activity meets the standard) the system has sent '%s' yuan to your account" => "Dear customer '%s', (team rebate promotion meets the requirement ) the system has sent '%s' PHP to your account",
    ...
    "Upgrade to %s with %s yuan bonus" => "Upgrade to %s with %s PHP bonus",
    ...
    "Dear %s, congratulations on upgrading from LV%s to %s. The number of lucky draw has reached %s" => "Dear %s, congratulations on upgrading from %s to %s. The number of lucky draw has reached %s",
    "Dear %s, congratulations on upgrading from LV%s to %s." => "Dear %s, congratulations on upgrading from %s to %s.",
    "Promotion news" => "Upgraded news",
    "Dear %s, the %s yuan prize money for LV%s card transfer has arrived" => "Dear %s, the %s PHP bonus for LV%s card transfer has arrived",
    "Offline recharge %s, LV%s card transfer bonus %s yuan" => "Offline recharge %s, LV%s card transfer bonus %s PHP",
    "Dear %s, your monthly salary and the system has sent %s yuan to your accountHere %s" => "Dear %s, your monthly salary and the system has sent %s PHP to your account %s",
    ...
    "Dear user, you have received %s yuan from %s on %s. Please check" => "Dear user, you have received %s PHP from %s on %s. Please check",
    "Dear user, your withdrawal of %s yuan on %s was rejected" => "Dear user, your withdrawal of %s PHP on %s was rejected",
    "Dear user, your withdrawal of %s yuan on %s was rejected, reason %s" => "Dear user, your withdrawal of %s PHP on %s was rejected, reason %s",
    ...
    'activity' => 'Promotion',
    'Achievement activity' => 'Achievement activities',
    'Day invite' => 'Daily invitations ',
    ...
    "yesterday_recharge_amount" => "Yesterday deposit amount",
    "bonus_amount" => "Bonus Amount",
    "total_apply" => "Total Apply",
    "success_apply" => "Success Apply",
    ...
    "Dear %s, Hello! You have successfully charged %s yuan" => "Dear %s, Hello! You have successfully deposit %s PHP",
    "Dear %s, Hello! %s yuan has arrived" => "Dear %s, Hello! %s PHP has arrived",
    ...
    "Dear %s, %s yuan from %s has arrived" => "Dear %s, %s PHP from %s has arrived",
    "Dear %s, Hello! Receive %s yuan from %s by hand" => "Dear %s, Hello! Receive %s PHP from %s by hand",
    ...
    "Dear %s ! Your recharge of %s yuan on %s has arrived" => "Dear %s ! Your recharge of %s PHP on %s has arrived",
    "Dear %s ! You participated in the recharge activities on %s, and %s yuan as a gift has arrived" => "Dear %s ! You participated in the recharge activities on %s, and %s PHP as a gift has arrived",
    "Recharge failed" => "Recharge failed",
    "Dear user, your recharge of %s yuan on %s was rejected. If you have any questions, please contact online customer service" => "Dear user, your recharge of %s PHP on %s was rejected. If you have any questions, please contact online customer service",
    "Dear user, you were refused to recharge %s yuan on %s. Reason for rejection: %s. If you have any questions, please contact online customer service" => "Dear user, your recharge %s PHP on %s was rejected. Reason: %s. If you have any questions, please contact online customer service",
    ...
    'realtime rebate' => 'realtime rebate',

    'Complete %s pay a bonus of %s' => 'Complete mission %s award %s',

    'today task' => "Today's task",
    'Direct withdrawal'     => 'Withdrawal',
    'Bind superior'         => 'Bind superior',
    'KOL salary' => 'KOL salary',
    'manual deposit' => 'Manual Deposit',
    'We will now open an activity to increase the return water ratio. Stay tuned!'   => 'We will now open an activity to increase the return water ratio. Stay tuned!',
];

//货币替换
$currency = $app->getContainer()->get('settings')['website']['currency'];
!defined('CURRENCY') && define('CURRENCY', $currency);
if($currency != 'PHP'){
    function replaceCurrency ($val){
        return str_replace('PHP', CURRENCY, $val);
    }
    return array_map('replaceCurrency', $res);
}
