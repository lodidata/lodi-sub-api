...
return [
    ...
    "Dear customer '%s', (team back service activity meets the standard) the system has sent '%s' yuan to your account" => "Dear customer '%s', (team rebate promotion meets the requirement ) the system has sent '%s' THB to your account",
    ...
    "Upgrade to %s with %s yuan bonus" => "Upgrade to %s with %s THB bonus",
    ...
    "Dear %s, the %s yuan prize money for LV%s card transfer has arrived" => "Dear %s, the %s THB bonus for LV%s card transfer has arrived",
    "Offline recharge %s, LV%s card transfer bonus %s yuan" => "Offline recharge %s, LV%s card transfer bonus %s THB",
    "Dear %s, your monthly salary and the system has sent %s yuan to your accountHere %s" => "Dear %s, your monthly salary and the system has sent %s THB to your account %s",
    ...
    "Dear user, you have received %s yuan from %s on %s. Please check" => "Dear user, you have received %s THB from %s on %s. Please check",
    "Dear user, your withdrawal of %s yuan on %s was rejected"         => "Dear user, your withdrawal of %s THB on %s was rejected",
    "Dear user, your withdrawal of %s yuan on %s was rejected, reason %s" => "Dear user, your withdrawal of %s THB on %s was rejected, reason %s",
    ...
    "Dear %s, Hello! You have successfully charged %s yuan" => "Dear %s, Hello! You have successfully deposit %s THB",
    "Dear %s, Hello! %s yuan has arrived" => "Dear %s, Hello! %s THB has arrived",
    ...
    "Dear %s, %s yuan from %s has arrived" => "Dear %s, %s THB from %s has arrived",
    "Dear %s, Hello! Receive %s yuan from %s by hand" => "Dear %s, Hello! Receive %s THB from %s by hand",
    ...
    "Dear %s ! Your recharge of %s yuan on %s has arrived" => "Dear %s ! Your recharge of %s THB on %s has arrived",
    "Dear %s ! You participated in the recharge activities on %s, and %s yuan as a gift has arrived" => "Dear %s ! You participated in the recharge activities on %s, and %s THB as a gift has arrived",
    "Recharge failed"                   => "Recharge failed",
    "Dear user, your recharge of %s yuan on %s was rejected. If you have any questions, please contact online customer service" => "Dear user, your recharge of %s THB on %s was rejected. If you have any questions, please contact online customer service",
    "Dear user, you were refused to recharge %s yuan on %s. Reason for rejection: %s. If you have any questions, please contact online customer service" => "Dear user, your recharge %s THB on %s was rejected. Reason: %s. If you have any questions, please contact online customer service",
